    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('p', 'Philantropist'), ('w', 'Ward'), ('c', 'Confectionary')], max_length=1, verbose_name='Статус пользователя')),
                ...
                ('avatar_user_img', models.ImageField(blank=True, null=True, upload_to='avatar_philantropist/', verbose_name='Аватар профиля')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name_confectionary', models.ForeignKey(default='', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='menu_confectionary', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'ordering': ['price_dish'],
            },
